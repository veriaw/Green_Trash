...
import com.veriaw.greentrash.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnLogin.setOnClickListener{
            ...
            viewModel.getUserByUsername(email).observe(this, Observer { user ->
                user?.let{
                    encryptedString=user.password
                    if(encryptedString!=null){
                        viewModel.getIvUser(email).observe(this, Observer {iv->
